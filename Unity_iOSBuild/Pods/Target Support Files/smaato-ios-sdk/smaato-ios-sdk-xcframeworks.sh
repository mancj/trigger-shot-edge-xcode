...
variant_for_slice()
{
  ...
  "SmaatoSDKRichMedia.xcframework/ios-arm64_x86_64-simulator")
    echo "simulator"
    ;;
  "SmaatoSDKUnifiedBidding.xcframework/ios-arm64")
    echo ""
    ;;
  "SmaatoSDKUnifiedBidding.xcframework/ios-arm64_x86_64-simulator")
    echo "simulator"
    ;;
...
install_xcframework "${PODS_ROOT}/smaato-ios-sdk/SmaatoSDKUnifiedBidding.xcframework" "smaato-ios-sdk/Modules/UnifiedBidding" "framework" "ios-arm64" "ios-arm64_x86_64-simulator"
