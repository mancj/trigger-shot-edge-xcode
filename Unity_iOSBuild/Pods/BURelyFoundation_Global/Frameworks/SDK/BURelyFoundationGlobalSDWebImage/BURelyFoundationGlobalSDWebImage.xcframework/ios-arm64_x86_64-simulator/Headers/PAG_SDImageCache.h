 ...
 */
//- (nullable NSOperation *)queryCacheOperationForKey:(nullable NSString *)key done:(nullable PAG_SDImageCacheQueryCompletionBlock)doneBlock;
 ...
 * @return a NSOperation instance containing the cache op
 */
- (nullable NSOperation *)queryCacheOperationForKey:(nullable NSString *)key options:(PAG_SDImageCacheOptions)options done:(nullable PAG_SDImageCacheQueryCompletionBlock)doneBlock;
