...
* Original Files：SDImageCachesManager/SDWebImage (https://github.com/SDWebImage/SDWebImage)
 ...
 */
@interface PAG_SDImageCachesManager : NSObject <PAG_SDImageCache>
 ...
 */
@property (nonatomic, class, readonly, nonnull) PAG_SDImageCachesManager *sharedManager;
 ...
 */
@property (nonatomic, copy, nullable) NSArray<id<PAG_SDImageCache>> *caches;
...
/**
 ...
 @param cache cache
 */
//- (void)addCache:(nonnull id<PAG_SDImageCache>)cache;
...
/**
 ...
 @param cache cache
 */
//- (void)removeCache:(nonnull id<PAG_SDImageCache>)cache;
