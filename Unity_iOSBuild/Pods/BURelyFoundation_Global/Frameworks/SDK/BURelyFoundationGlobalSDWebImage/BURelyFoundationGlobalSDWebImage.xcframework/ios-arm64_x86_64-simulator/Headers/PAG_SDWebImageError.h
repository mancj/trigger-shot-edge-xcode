...
FOUNDATION_EXPORT NSErrorDomain const _Nonnull PAG_SDWebImageErrorDomain;

/// The HTTP status code for invalid download response (NSNumber *)
FOUNDATION_EXPORT NSErrorUserInfoKey const _Nonnull PAG_SDWebImageErrorDownloadStatusCodeKey;

/// SDWebImage error domain and codes
typedef NS_ERROR_ENUM(PAG_SDWebImageErrorDomain, SDWebImageError) {
    ...
    SDWebImageErrorInvalidDownloadStatusCode = 2001, // The image download response a invalid status code. You can check the status code in error's userInfo under `PAG_SDWebImageErrorDownloadStatusCodeKey`
