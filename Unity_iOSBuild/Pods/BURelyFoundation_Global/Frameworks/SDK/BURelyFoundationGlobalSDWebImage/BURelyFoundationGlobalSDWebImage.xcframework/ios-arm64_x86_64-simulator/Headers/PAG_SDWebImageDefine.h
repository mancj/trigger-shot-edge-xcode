...
typedef NSString * PAG_SDWebImageContextOption NS_EXTENSIBLE_STRING_ENUM;
typedef NSDictionary<PAG_SDWebImageContextOption, id> SDWebImageContext;
typedef NSMutableDictionary<PAG_SDWebImageContextOption, id> SDWebImageMutableContext;
...
/**
 ...
 However, you can also provide custom scale factor as well, see `PAG_SDWebImageContextImageScaleFactor`.

 @param key The image cache key
 @return The scale factor for image
 */
FOUNDATION_EXPORT CGFloat PAG_SDImageScaleFactorForKey(NSString * _Nullable key);
...
/**
 ...
 @note This is actually a convenience function, which firstlly call `PAG_SDImageScaleFactorForKey` and then call `BU_SDScaledImageForScaleFactor`, kept for backward compatibility.

 @param key The image cache key
 @param image The image
 @return The scaled image
 */
FOUNDATION_EXPORT UIImage * _Nullable PAG_SDScaledImageForKey(NSString * _Nullable key, UIImage * _Nullable image);
...
/**
 ...
 @return The scaled image
 */
FOUNDATION_EXPORT UIImage * _Nullable PAG_SDScaledImageForScaleFactor(CGFloat scale, UIImage * _Nullable image);

#pragma mark - WebCache Options

/// BU_WebCache options
typedef NS_OPTIONS(NSUInteger, PAG_SDWebImageOptions) {
    /**
    ...
    /**
     * By default, when you use `PAG_SDWebImageContextAnimatedImageClass` context option (like using `SDAnimatedImageView` which designed to use `BU_SDAnimatedImage`), we may still use `UIImage` when the memory cache hit, or image decoder is not available to produce one exactlly matching your custom class as a fallback solution.
 ...
 */
FOUNDATION_EXPORT PAG_SDWebImageContextOption _Nonnull const PAG_SDWebImageContextSetImageOperationKey;
 ...
 */
FOUNDATION_EXPORT PAG_SDWebImageContextOption _Nonnull const PAG_SDWebImageContextCustomManager;

/**
 A id<PAG_SDImageTransformer> instance which conforms `BU_SDImageTransformer` protocol. It's used for image transform after the image load finished and store the transformed image to cache. If you provide one, it will ignore the `transformer` in manager and use provided one instead. (id<PAG_SDImageTransformer>)
 */
FOUNDATION_EXPORT PAG_SDWebImageContextOption _Nonnull const PAG_SDWebImageContextImageTransformer;
 ...
 */
FOUNDATION_EXPORT PAG_SDWebImageContextOption _Nonnull const PAG_SDWebImageContextOriginalStoreCacheType;
 ...
 */
FOUNDATION_EXPORT PAG_SDWebImageContextOption _Nonnull const PAG_SDWebImageContextAnimatedImageClass;
 ...
 */
FOUNDATION_EXPORT PAG_SDWebImageContextOption _Nonnull const PAG_SDWebImageContextDownloadRequestModifier;

/**
 A id<PAG_SDWebImageCacheKeyFilter> instance to convert an URL into a cache key. It's used when manager need cache key to use image cache. If you provide one, it will ignore the `cacheKeyFilter` in manager and use provided one instead. (id<PAG_SDWebImageCacheKeyFilter>)
 */
FOUNDATION_EXPORT PAG_SDWebImageContextOption _Nonnull const PAG_SDWebImageContextCacheKeyFilter;

/**
 A id<PAG_SDWebImageCacheSerializer> instance to convert the decoded image, the source downloaded data, to the actual data. It's used for manager to store image to the disk cache. If you provide one, it will ignore the `cacheSerializer` in manager and use provided one instead. (id<PAG_SDWebImageCacheSerializer>)
 */
FOUNDATION_EXPORT PAG_SDWebImageContextOption _Nonnull const PAG_SDWebImageContextCacheSerializer;
