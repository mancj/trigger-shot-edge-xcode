 ...
 */
@interface PAG_SDWebImageDownloaderConfig : NSObject <NSCopying>
 ...
 */
@property (nonatomic, class, readonly, nonnull) PAG_SDWebImageDownloaderConfig *defaultDownloaderConfig;
