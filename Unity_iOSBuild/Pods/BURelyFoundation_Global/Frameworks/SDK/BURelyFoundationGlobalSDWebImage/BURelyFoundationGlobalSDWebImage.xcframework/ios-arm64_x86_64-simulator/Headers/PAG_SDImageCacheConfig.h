...
* Original Files：SDImageCacheConfig/SDWebImage (https://github.com/SDWebImage/SDWebImage)
...
typedef NS_ENUM(NSUInteger, PAG_SDImageCacheConfigExpireType) {
    /**
     * When the image is accessed it will update this value
     */
    PAG_SDImageCacheConfigExpireTypeAccessDate,
    /**
     * The image was obtained from the disk cache (Default)
     */
    PAG_SDImageCacheConfigExpireTypeModificationDate
};
 ...
 */
@interface PAG_SDImageCacheConfig : NSObject <NSCopying>
 ...
 */
@property (nonatomic, class, readonly, nonnull) PAG_SDImageCacheConfig *defaultCacheConfig;
 ...
 */
@property (assign, nonatomic) PAG_SDImageCacheConfigExpireType diskCacheExpireType;
