 ...
 */
- (nullable UIImage *)sdPAG_resizedImageWithSize:(CGSize)size scaleMode:(PAG_SDImageScaleMode)scaleMode;
 ...
 */
- (nullable UIImage *)sdPAG_croppedImageWithRect:(CGRect)rect;
 ...
 */
- (nullable UIImage *)sdPAG_rotatedImageWithAngle:(CGFloat)angle fitSize:(BOOL)fitSize;
 ...
 */
- (nullable UIImage *)sdPAG_flippedImageWithHorizontal:(BOOL)horizontal vertical:(BOOL)vertical;
 ...
 */
- (nullable UIImage *)sdPAG_tintedImageWithColor:(nonnull UIColor *)tintColor;
 ...
 */
- (nullable UIColor *)sdPAG_colorAtPoint:(CGPoint)point;
 ...
 */
- (nullable NSArray<UIColor *> *)sdPAG_colorsWithRect:(CGRect)rect;
 ...
 */
- (nullable UIImage *)sdPAG_blurredImageWithRadius:(CGFloat)blurRadius;
...
/**
 ...
 enough memory).
 */
- (nullable UIImage *)sdPAG_filteredImageWithFilter:(nonnull CIFilter *)filter;
#endif
