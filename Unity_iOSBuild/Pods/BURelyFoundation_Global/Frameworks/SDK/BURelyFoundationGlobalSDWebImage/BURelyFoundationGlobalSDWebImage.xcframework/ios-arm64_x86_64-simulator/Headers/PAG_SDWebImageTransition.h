...
typedef void (^SDWebImageTransitionPreparesBlock)(__kindof UIView * _Nonnull view, UIImage * _Nullable image, NSData * _Nullable imageData, PAG_SDImageCacheType cacheType, NSURL * _Nullable imageURL);
 ...
 */
@interface PAG_SDWebImageTransition : NSObject
 ...
 */
//@interface PAG_SDWebImageTransition (Conveniences)
//
///// Fade transition.
////@property (nonatomic, class, nonnull, readonly) PAG_SDWebImageTransition *fadeTransition;
///// Flip from left transition.
////@property (nonatomic, class, nonnull, readonly) PAG_SDWebImageTransition *flipFromLeftTransition;
///// Flip from right transition.
//@property (nonatomic, class, nonnull, readonly) PAG_SDWebImageTransition *flipFromRightTransition;
///// Flip from top transition.
//@property (nonatomic, class, nonnull, readonly) PAG_SDWebImageTransition *flipFromTopTransition;
///// Flip from bottom transition.
//@property (nonatomic, class, nonnull, readonly) PAG_SDWebImageTransition *flipFromBottomTransition;
///// Curl up transition.
//@property (nonatomic, class, nonnull, readonly) PAG_SDWebImageTransition *curlUpTransition;
///// Curl down transition.
//@property (nonatomic, class, nonnull, readonly) PAG_SDWebImageTransition *curlDownTransition;
//
//@end
