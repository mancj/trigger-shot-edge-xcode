...
* Original Files：SDImageCodersManager/SDWebImage (https://github.com/SDWebImage/SDWebImage)
 ...
 */
@interface PAG_SDImageCodersManager : NSObject <PAG_SDImageCoder>

/**
 Returns the global shared coders manager instance.
 */
@property (nonatomic, class, readonly, nonnull) PAG_SDImageCodersManager *sharedManager;
 ...
 */
@property (nonatomic, copy, nullable) NSArray<id<PAG_SDImageCoder>> *coders;
...
/**
 ...
 @param coder coder
 */
//- (void)addCoder:(nonnull id<PAG_SDImageCoder>)coder;
...
/**
 ...
 @param coder coder
 */
//- (void)removeCoder:(nonnull id<PAG_SDImageCoder>)coder;
