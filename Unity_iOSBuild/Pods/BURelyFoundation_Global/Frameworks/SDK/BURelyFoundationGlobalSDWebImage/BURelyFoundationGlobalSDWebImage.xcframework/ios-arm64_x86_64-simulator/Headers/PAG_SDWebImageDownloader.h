...
#import "PAG_SDWebImageDownloaderConfig.h"
#import "PAG_SDWebImageDownloaderRequestModifier.h"
...
FOUNDATION_EXPORT NSNotificationName _Nonnull const PAG_SDWebImageDownloadStartNotification;
FOUNDATION_EXPORT NSNotificationName _Nonnull const PAG_SDWebImageDownloadReceiveResponseNotification;
FOUNDATION_EXPORT NSNotificationName _Nonnull const PAG_SDWebImageDownloadStopNotification;
FOUNDATION_EXPORT NSNotificationName _Nonnull const PAG_SDWebImageDownloadFinishNotification;
 ...
 */
@interface PAG_SDWebImageDownloadToken : NSObject <PAG_SDWebImageOperation>
 ...
 */
@interface PAG_SDWebImageDownloader : NSObject
 ...
 */
@property (nonatomic, copy, readonly, nonnull) PAG_SDWebImageDownloaderConfig *config;
 ...
 * @note If you want to modify single request, consider using `PAG_SDWebImageContextDownloadRequestModifier` context option.
 */
@property (nonatomic, strong, nullable) id<SDWebImageDownloaderRequestModifier> requestModifier;

/**
 * The configuration in use by the internal NSURLSession. If you want to provide a custom sessionConfiguration, use `PAG_SDWebImageDownloaderConfig.sessionConfiguration` and create a new downloader instance.
...
/**
 *  Returns the global shared downloader instance. Which use the `PAG_SDWebImageDownloaderConfig.defaultDownloaderConfig` config.
 */
@property (nonatomic, class, readonly, nonnull) PAG_SDWebImageDownloader *sharedDownloader;
 ...
 */
- (nonnull instancetype)initWithConfig:(nullable PAG_SDWebImageDownloaderConfig *)config NS_DESIGNATED_INITIALIZER;
 ...
 */
//- (nullable PAG_SDWebImageDownloadToken *)downloadImageWithURL:(nullable NSURL *)url
 ...
 */
@interface PAG_SDWebImageDownloader (SDImageLoader) <PAG_SDImageLoader>
