 ...
 */
@interface UIImageView (PAGHighlightedWebCache)
 ...
 */
- (void)sdPAG_setHighlightedImageWithURL:(nullable NSURL *)url NS_REFINED_FOR_SWIFT;
 ...
 */
- (void)sdPAG_setHighlightedImageWithURL:(nullable NSURL *)url
