...
#define onExit \
sd_keywordify \
__strong pag_sd_cleanupBlock_t metamacro_concat(sd_exitBlock_, __LINE__) __attribute__((cleanup(pag_sd_executeCleanupBlock), unused)) = ^
#endif

typedef void (^pag_sd_cleanupBlock_t)(void);

#if defined(__cplusplus)
extern "C" {
#endif
    void pag_sd_executeCleanupBlock (__strong pag_sd_cleanupBlock_t *block);
#if defined(__cplusplus)
}
#endif
