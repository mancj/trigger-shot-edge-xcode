...
* Original Files：SDImageCoder/SDWebImage (https://github.com/SDWebImage/SDWebImage)
 ...
 */
FOUNDATION_EXPORT SDImageCoderOption _Nonnull const PAG_SDImageCoderDecodeFirstFrameOnly;
/**
 ...
 @note works for `SDImageCoder`, `SDProgressiveImageCoder`, `<PAG_SDAnimatedImageCoder>`.
 */
FOUNDATION_EXPORT SDImageCoderOption _Nonnull const PAG_SDImageCoderDecodeScaleFactor;
...
/**
 ...
 @note works for `SDImageCoder`.
 */
FOUNDATION_EXPORT SDImageCoderOption _Nonnull const PAG_SDImageCoderEncodeFirstFrameOnly;
/**
 ...
 @note works for `SDImageCoder`
 */
FOUNDATION_EXPORT SDImageCoderOption _Nonnull const PAG_SDImageCoderEncodeCompressionQuality;
 ...
 */
FOUNDATION_EXPORT SDImageCoderOption _Nonnull const PAG_SDImageCoderWebImageContext;
...
/**
 ...
 @note works for `SDImageCoder`, `SDProgressiveImageCoder`, `<PAG_SDAnimatedImageCoder>`.
 */
FOUNDATION_EXPORT SDImageCoderOption _Nonnull const PAG_SDImageCoderDecodePreserveAspectRatio;
...
/**
 ...
 @note works for `SDImageCoder`, `SDProgressiveImageCoder`, `<PAG_SDAnimatedImageCoder>`.
 */
FOUNDATION_EXPORT SDImageCoderOption _Nonnull const PAG_SDImageCoderDecodeThumbnailPixelSize;
 ...
 */
@protocol PAG_SDImageCoder <NSObject>
...
/**
 ...
 @param options A dictionary containing any decoding options. Pass @{PAG_SDImageCoderDecodeScaleFactor: @(1.0)} to specify scale factor for image. Pass @{PAG_SDImageCoderDecodeFirstFrameOnly: @(YES)} to decode the first frame only.
 ...
 */
- (BOOL)canEncodeToFormat:(PAG_SDImageFormat)format NS_SWIFT_NAME(canEncode(to:));
...
/**
 ...
 @param options A dictionary containing any encoding options. Pass @{PAG_SDImageCoderEncodeCompressionQuality: @(1)} to specify compression quality.
 @return The encoded image data
 */
- (nullable NSData *)encodedDataWithImage:(nullable UIImage *)image
                                   format:(PAG_SDImageFormat)format
                                  options:(nullable SDImageCoderOptions *)options;
...
/**
 ...
 @note Pay attention that these methods are not called from main queue.
 */
@protocol PAG_SDProgressiveImageCoder <PAG_SDImageCoder>
...
/**
 ...
 @param options A dictionary containing any progressive decoding options (instance-level). Pass @{PAG_SDImageCoderDecodeScaleFactor: @(1.0)} to specify scale factor for progressive animated image (each frames should use the same scale).
...
/**
 ...
 @note Due to the performance issue for progressive decoding and the integration for image view. This method may only return the first frame image even if the image data is animated image. If you want progressive animated image decoding, conform to `<PAG_SDAnimatedImageCoder>` protocol as well and use `animatedImageFrameAtIndex:` instead.

 @param options A dictionary containing any progressive decoding options. Pass @{PAG_SDImageCoderDecodeScaleFactor: @(1.0)} to specify scale factor for progressive image
...
/**
 This is the animated image protocol to provide the basic function for animated image rendering. It's adopted by `BU_SDAnimatedImage` and `<PAG_SDAnimatedImageCoder>`
 */
@protocol PAG_SDAnimatedImageProvider <NSObject>
 ...
 */
@protocol PAG_SDAnimatedImageCoder <PAG_SDImageCoder, PAG_SDAnimatedImageProvider>
...
/**
 ...
 @param options A dictionary containing any animated decoding options (instance-level). Pass @{PAG_SDImageCoderDecodeScaleFactor: @(1.0)} to specify scale factor for animated image (each frames should use the same scale).
