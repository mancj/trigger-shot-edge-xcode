...
@class PAG_SDWebImagePrefetcher;

/**
 A token represents a list of URLs, can be used to cancel the download.
 */
@interface PAG_SDWebImagePrefetchToken : NSObject <PAG_SDWebImageOperation>
 ...
 */
@protocol PAG_SDWebImagePrefetcherDelegate <NSObject>
 ...
 */
- (void)imagePrefetcher:(nonnull PAG_SDWebImagePrefetcher *)imagePrefetcher didPrefetchURL:(nullable NSURL *)imageURL finishedCount:(NSUInteger)finishedCount totalCount:(NSUInteger)totalCount;
 ...
 */
- (void)imagePrefetcher:(nonnull PAG_SDWebImagePrefetcher *)imagePrefetcher didFinishWithTotalCount:(NSUInteger)totalCount skippedCount:(NSUInteger)skippedCount;
 ...
 */
@interface PAG_SDWebImagePrefetcher : NSObject
 ...
 */
@property (strong, nonatomic, readonly, nonnull) PAG_SDWebImageManager *manager;
 ...
 */
@property (nonatomic, assign) PAG_SDWebImageOptions options;
 ...
 */
@property (weak, nonatomic, nullable) id <PAG_SDWebImagePrefetcherDelegate> delegate;

/**
 * Returns the global shared image prefetcher instance. It use a standalone manager which is different from shared manager.
 */
@property (nonatomic, class, readonly, nonnull) PAG_SDWebImagePrefetcher *sharedImagePrefetcher;

/**
 * Allows you to instantiate a prefetcher with any arbitrary image manager.
 */
- (nonnull instancetype)initWithImageManager:(nonnull PAG_SDWebImageManager *)manager NS_DESIGNATED_INITIALIZER;
 ...
 */
//- (nullable PAG_SDWebImagePrefetchToken *)prefetchURLs:(nullable NSArray<NSURL *> *)urls;
