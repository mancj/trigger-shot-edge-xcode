 ...
 */
+ (nullable UIImage *)sdPAG_decodedImageWithImage:(nullable UIImage *)image;
 ...
 */
+ (nullable UIImage *)sdPAG_decodedAndScaledDownImageWithImage:(nullable UIImage *)image;
...
/**
 ...
 @return The decoded and scaled down image
 */
+ (nullable UIImage *)sdPAG_decodedAndScaledDownImageWithImage:(nullable UIImage *)image limitBytes:(NSUInteger)bytes;
