...
* Original Files：NSButton+WebCache/SDWebImage (https://github.com/SDWebImage/SDWebImage)
 ...
 * @param url         The url for the alternateImage.
 * @param placeholder The alternateImage to be set initially, until the alternateImage request finishes.
 * @param options     The options to use when downloading the alternateImage. @see PAG_SDWebImageOptions for the possible values.
 */
- (void)sdBu_setAlternateImageWithURL:(nullable NSURL *)url
                   placeholderImage:(nullable UIImage *)placeholder
                            options:(PAG_SDWebImageOptions)options NS_REFINED_FOR_SWIFT;
