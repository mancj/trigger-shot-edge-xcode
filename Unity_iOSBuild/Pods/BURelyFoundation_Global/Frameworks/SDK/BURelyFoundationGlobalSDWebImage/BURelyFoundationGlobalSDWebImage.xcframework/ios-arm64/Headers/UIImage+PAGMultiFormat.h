 ...
 */
@interface UIImage (PAGMultiFormat)
#pragma mark - Decode
/**
 ...
 */
+ (nullable UIImage *)sdPAG_imageWithData:(nullable NSData *)data;
...
/**
 ...
 @return The created image
 */
+ (nullable UIImage *)sdPAG_imageWithData:(nullable NSData *)data scale:(CGFloat)scale;
...
/**
 ...
 @return The created image
 */
+ (nullable UIImage *)sdPAG_imageWithData:(nullable NSData *)data scale:(CGFloat)scale firstFrameOnly:(BOOL)firstFrameOnly;
 ...
 */
- (nullable NSData *)sdPAG_imageData;
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)sdPAG_imageDataAsFormat:(PAG_SDImageFormat)imageFormat NS_SWIFT_NAME(sdBu_imageData(as:));
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)sdPAG_imageDataAsFormat:(PAG_SDImageFormat)imageFormat compressionQuality:(double)compressionQuality NS_SWIFT_NAME(sdBu_imageData(as:compressionQuality:));
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)sdPAG_imageDataAsFormat:(PAG_SDImageFormat)imageFormat compressionQuality:(double)compressionQuality firstFrameOnly:(BOOL)firstFrameOnly NS_SWIFT_NAME(sdBu_imageData(as:compressionQuality:firstFrameOnly:));
