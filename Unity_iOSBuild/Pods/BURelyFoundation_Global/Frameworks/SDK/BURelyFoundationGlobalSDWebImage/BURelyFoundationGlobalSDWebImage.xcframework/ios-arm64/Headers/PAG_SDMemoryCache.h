 ...
 */
@protocol PAG_SDMemoryCache <NSObject>
 ...
 */
- (nonnull instancetype)initWithConfig:(nonnull PAG_SDImageCacheConfig *)config;
 ...
 */
@interface PAG_SDMemoryCache <KeyType, ObjectType> : NSCache <KeyType, ObjectType> <PAG_SDMemoryCache>

@property (nonatomic, strong, nonnull, readonly) PAG_SDImageCacheConfig *config;
