 ...
 */
+ (nullable instancetype)PAGYY_modelWithJSON:(id)json;
 ...
 */
- (BOOL)PAGYY_modelSetWithJSON:(id)json;
 ...
 */
- (nullable NSData *)PAGYY_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)PAGYY_modelToJSONString;
 ...
 */
- (void)PAGYY_modelEncodeWithCoder:(NSCoder *)aCoder;
...
/**
 ...
 @return self
 */
- (id)PAGYY_modelInitWithCoder:(NSCoder *)aDecoder;
 ...
 */
- (BOOL)PAGYY_modelIsEqual:(id)model;
 ...
 */
- (NSString *)PAGYY_modelDescription;
 ...
 */
+ (nullable NSArray *)PAGYY_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (PAGYYModel)
 ...
 */
+ (nullable NSDictionary *)PAGYY_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<PAGYYModel>' to your class header.
 */
