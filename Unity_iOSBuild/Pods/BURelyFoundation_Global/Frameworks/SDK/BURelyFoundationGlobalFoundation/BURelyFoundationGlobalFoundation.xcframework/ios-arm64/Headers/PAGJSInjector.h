...
/**
 ...
 有两个级别:
 1. webview级别, 只对当前webview生效. PAGWebView.injector
 2. 全局级别, 对所有webview生效. [PAGJSInjector sharedInstance]
 
 请自行根据需求使用, 不要滥用全局级别
 
 */

@interface PAGJSInjector : NSObject
...
/**
 ...
 @param webview PAGWebView
 */
- (void)injectScriptInWebView:(UIView<PAGWebView> *)webview;
@end
