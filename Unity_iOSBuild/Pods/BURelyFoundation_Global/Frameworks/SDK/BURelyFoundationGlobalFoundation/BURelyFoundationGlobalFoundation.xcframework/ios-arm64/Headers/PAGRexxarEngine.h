...
#import "PAGStaticPlugin.h"

@protocol PAGJSBAuthorization;
@protocol PAGRexxarEngine <NSObject>
 ...
 */
@property (nonatomic, strong) PAGStaticPlugin *ttr_staticPlugin;
 ...
 */
@property (nonatomic, strong) id<PAGJSBAuthorization> ttr_authorization;
