...
@protocol YMANativeViewProvider;
...
/**
 ...
 @param sliderView Root slider ad view
 @param viewProvider Provider for inner ad views
 @param error Binding error. @see YMANativeAdErrors.h for error codes.
 @return YES if binding succeeded, otherwise NO.
 */
- (BOOL)bindAdToSliderView:(UIView<YMANativeSliderView> *)sliderView
              viewProvider:(id<YMANativeViewProvider>)viewProvider
                     error:(NSError **)error;
